                        ...
                        <div id="importForm" class="hidden mt-6 p-4 bg-gray-50 dark:bg-gray-900 rounded-lg border-2 border-purple-200 dark:border-purple-800">
                            ...
                            <form action="{{ route('students.import') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                                ...
                                <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-4">
                                    ...
                                    <div class="mt-3">
                                        <a href="{{ asset('sample_student_import_format.csv') }}" download class="inline-flex items-center text-sm font-medium text-blue-700 dark:text-blue-300 hover:text-blue-900 dark:hover:text-blue-100">
                                            ...
                                            @foreach($students as $student)
                                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm space-x-2">
                                                        @role('admin')
                                                            <a href="{{ route('admin.users.edit', $student) }}" class="text-indigo-600 hover:text-indigo-800 dark:text-indigo-400">
                                                                Edit
                                                            </a>
                                                        @endrole
