<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.assignments.index') }}" class="text-blue-600 hover:text-blue-800 dark:text-blue-400">
                ← Back to Assignments
            </a>
        </div>
    </x-slot>
                ...
                <div class="p-6">
                    <form action="{{ route('admin.assignments.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="course_id" id="course_id" required onchange="updateTeacher()"
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                <option value="">Select a course...</option>
                                @foreach($courses as $course)
                                    <option value="{{ $course->id }}" data-teacher="{{ $course->teacher_id }}" {{ old('course_id') == $course->id ? 'selected' : '' }}>
                        ...
                        <div class="flex justify-end space-x-3">
                            <a href="{{ route('admin.assignments.index') }}" class="bg-gray-300 dark:bg-gray-600 hover:bg-gray-400 dark:hover:bg-gray-700 text-gray-800 dark:text-gray-200 px-6 py-2 rounded-md">
                                Cancel
                            </a>
